...
public class ProductInfoDTOTest {
	...
	public void testGetProductDescription12() {
		ProductInfoDTO dto = new ProductInfoDTO();
		String expected = "ａｂｃ１２３あいう１２３漢字";
	...
	@Test
	public void testGetCategolyId2() {
		ProductInfoDTO dto = new ProductInfoDTO();
		int expected = 2147483647;
	...
	@Test
	public void testGetCategolyId3() {
		ProductInfoDTO dto = new ProductInfoDTO();
		int expected = -2147483647;
	...
	@Test
	public void testGetCategolyId4() throws Exception {
		ProductInfoDTO dto = new ProductInfoDTO();
		try{
	...
	@Test
	public void testGetCategolyId5() throws Exception {
		ProductInfoDTO dto = new ProductInfoDTO();
		try{
			int postalMin = Integer.parseInt("-2147483648");
