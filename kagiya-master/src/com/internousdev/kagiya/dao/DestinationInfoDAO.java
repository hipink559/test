...
//	//重複住所確認。
//	public ArrayList<DestinationInfoDTO>userAddressCheck(){
//
//		DBConnector dbConnector=new DBConnector();
//		Connection con=dbConnector.getConnection();
//		ArrayList<DestinationInfoDTO>destinationInfo=new ArrayList<DestinationInfoDTO>();
//
//		String sql="SELECT user_address FROM destination_info";
//
//		try{
//			PreparedStatement ps=con.prepareStatement(sql);
...
//				destinationInfo.add(destinationInfoDTO);
//			}
//		}
//		catch(Exception e){
//			e.printStackTrace();
...
//	}
	...
	//重複住所確認。
		public ArrayList<DestinationInfoDTO>userAddressCheck(String userId){

			DBConnector dbConnector=new DBConnector();
			Connection con=dbConnector.getConnection();
			ArrayList<DestinationInfoDTO>destinationInfo=new ArrayList<DestinationInfoDTO>();

			String sql="SELECT user_address FROM destination_info WHERE user_id = ?";
